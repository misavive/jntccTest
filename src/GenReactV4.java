...
import utcclang.*;
    ...
    public  class GenReactV4 {
        ...
        public static void main(String[] args) {
              ...
              utcclang.Store.setFilename("GenReactV4.txt");
              ...
              // the instruction change modify the value initial of variables in next unit time.
                ...
                IntVar a = utcclang.Store.getStore().creavarsRetor("a",0,300);
                 IntVar b = utcclang.Store.getStore().creavarsRetor("b",0,300);
                 IntVar c = utcclang.Store.getStore().creavarsRetor("c",0,300);
                 IntVar d = utcclang.Store.getStore().creavarsRetor("d",0,300);
                 IntVar e = utcclang.Store.getStore().creavarsRetor("e",0,300);
                 IntVar f = utcclang.Store.getStore().creavarsRetor("f",0,300);
                 IntVar g = utcclang.Store.getStore().creavarsRetor("g",0,300);
                 IntVar h = utcclang.Store.getStore().creavarsRetor("h",0,300);
                 IntVar i = utcclang.Store.getStore().creavarsRetor("i",0,300);
                 IntVar j = utcclang.Store.getStore().creavarsRetor("j",0,300);
                 IntVar k = utcclang.Store.getStore().creavarsRetor("k",0,300);
                 IntVar l = utcclang.Store.getStore().creavarsRetor("l",0,300);
                 IntVar m = utcclang.Store.getStore().creavarsRetor("m",0,300);
              ...
              //Declaration of Process.
                  ...
                  Procesos P101 =      new Par(  new Change(a, Operation._DECRE,8), 
                    new Change(g, Operation._DECRE,7), 
                    new Change(h, Operation._DECRE,1),
                     new Change(m, Operation._INCRE,5) ) ;
                   
                  Procesos P102 =      new Par(  new Change(a, Operation._DECRE,2), 
                    new Change(g, Operation._DECRE,2), 
                    new Change(j, Operation._DECRE,1),
                     new Change(l, Operation._INCRE,1) ) ;
                   
                  Procesos P103 =      new Par(  new Change(a, Operation._DECRE,4), 
                    new Change(g, Operation._DECRE,2), 
                    new Change(j, Operation._DECRE,1),
                     new Change(k, Operation._INCRE,5) ) ;
                   
                  Procesos P104 =      new Par(  new Change(a, Operation._DECRE,4),
                     new Change(g, Operation._INCRE,3), 
                     new Change(j, Operation._INCRE,10), 
                     new Change(m, Operation._INCRE,9) ) ;
                   
                  Procesos P105 =      new Par(  new Change(a, Operation._DECRE,6),
                     new Change(g, Operation._INCRE,10), 
                     new Change(i, Operation._INCRE,7), 
                     new Change(l, Operation._INCRE,9) ) ;
                   
                  Procesos P106 =      new Par(  new Change(a, Operation._DECRE,1),
                     new Change(g, Operation._INCRE,7), 
                     new Change(i, Operation._INCRE,7), 
                     new Change(k, Operation._INCRE,9) ) ;
                   
                  Procesos P107 =      new Par(  new Change(i, Operation._DECRE,4), 
                    new Change(m, Operation._DECRE,8),
                     new Change(a, Operation._INCRE,1), 
                     new Change(g, Operation._INCRE,3) ) ;
                   
                  Procesos P108 =      new Par(  new Change(a, Operation._DECRE,5), 
                    new Change(h, Operation._DECRE,7), 
                    new Change(i, Operation._DECRE,6),
                     new Change(m, Operation._INCRE,9) ) ;
                   
                  Procesos P109 =      new Par(  new Change(a, Operation._DECRE,3), 
                    new Change(h, Operation._DECRE,5), 
                    new Change(i, Operation._DECRE,8),
                     new Change(l, Operation._INCRE,8) ) ;
                   
                  Procesos P110 =      new Par(  new Change(a, Operation._DECRE,4),
                     new Change(h, Operation._INCRE,3), 
                     new Change(i, Operation._INCRE,4), 
                     new Change(k, Operation._INCRE,9) ) ;
                   
                  Procesos P111 =      new Par(  new Change(a, Operation._DECRE,2), 
                    new Change(h, Operation._DECRE,5), 
                    new Change(j, Operation._DECRE,4),
                     new Change(m, Operation._INCRE,5) ) ;
                   
                  Procesos P112 =      new Par(  new Change(a, Operation._DECRE,5), 
                    new Change(h, Operation._DECRE,5), 
                    new Change(j, Operation._DECRE,7),
                     new Change(k, Operation._INCRE,6) ) ;
                   
                  Procesos P113 =      new Par(  new Change(j, Operation._DECRE,5), 
                    new Change(l, Operation._DECRE,3),
                     new Change(a, Operation._INCRE,1), 
                     new Change(h, Operation._INCRE,2) ) ;
                   
                  Procesos P114 =      new Par(  new Change(h, Operation._DECRE,6), 
                    new Change(l, Operation._DECRE,8),
                     new Change(a, Operation._INCRE,9), 
                     new Change(e, Operation._INCRE,3) ) ;
                   
                  Procesos P115 =      new Par(  new Change(h, Operation._DECRE,3), 
                    new Change(m, Operation._DECRE,8),
                     new Change(a, Operation._INCRE,4), 
                     new Change(e, Operation._INCRE,7) ) ;
                   
                  Procesos P116 =      new Par(  new Change(a, Operation._DECRE,7), 
                    new Change(e, Operation._DECRE,4), 
                    new Change(h, Operation._DECRE,1),
                     new Change(k, Operation._INCRE,10) ) ;
                   
                  Procesos P117 =      new Par(  new Change(a, Operation._DECRE,4),
                     new Change(e, Operation._INCRE,8), 
                     new Change(j, Operation._INCRE,4), 
                     new Change(l, Operation._INCRE,6) ) ;
                   
                  Procesos P118 =      new Par(  new Change(a, Operation._DECRE,1),
                     new Change(e, Operation._INCRE,2), 
                     new Change(j, Operation._INCRE,7), 
                     new Change(k, Operation._INCRE,3) ) ;
                   
                  Procesos P119 =      new Par(  new Change(a, Operation._DECRE,8), 
                    new Change(e, Operation._DECRE,2), 
                    new Change(j, Operation._DECRE,5),
                     new Change(m, Operation._INCRE,7) ) ;
                   
                  Procesos P120 =      new Par(  new Change(i, Operation._DECRE,6), 
                    new Change(m, Operation._DECRE,6),
                     new Change(a, Operation._INCRE,2), 
                     new Change(e, Operation._INCRE,1) ) ;
                   
                  Procesos P121 =      new Par(  new Change(a, Operation._DECRE,8), 
                    new Change(e, Operation._DECRE,1), 
                    new Change(i, Operation._DECRE,3),
                     new Change(k, Operation._INCRE,1) ) ;
                   
                  Procesos P122 =      new Par(  new Change(a, Operation._DECRE,8),
                     new Change(e, Operation._INCRE,5), 
                     new Change(i, Operation._INCRE,2), 
                     new Change(l, Operation._INCRE,8) ) ;
                   
                  Procesos P123 =      new Par(  new Change(i, Operation._DECRE,5), 
                    new Change(m, Operation._DECRE,6),
                     new Change(a, Operation._INCRE,10), 
                     new Change(f, Operation._INCRE,7) ) ;
                   
                  Procesos P124 =      new Par(  new Change(a, Operation._DECRE,5), 
                    new Change(f, Operation._DECRE,7), 
                    new Change(i, Operation._DECRE,3),
                     new Change(k, Operation._INCRE,10) ) ;
                   
                  Procesos P125 =      new Par(  new Change(a, Operation._DECRE,7), 
                    new Change(f, Operation._DECRE,8), 
                    new Change(i, Operation._DECRE,6),
                     new Change(l, Operation._INCRE,3) ) ;
                   
                  Procesos P126 =      new Par(  new Change(a, Operation._DECRE,2), 
                    new Change(f, Operation._DECRE,3), 
                    new Change(h, Operation._DECRE,1),
                     new Change(m, Operation._INCRE,1) ) ;
                   
                  Procesos P127 =      new Par(  new Change(h, Operation._DECRE,1), 
                    new Change(l, Operation._DECRE,2),
                     new Change(a, Operation._INCRE,8), 
                     new Change(f, Operation._INCRE,1) ) ;
                   
                  Procesos P128 =      new Par(  new Change(h, Operation._DECRE,2), 
                    new Change(k, Operation._DECRE,7),
                     new Change(a, Operation._INCRE,3), 
                     new Change(f, Operation._INCRE,2) ) ;
                   
                  Procesos P129 =      new Par(  new Change(a, Operation._DECRE,3),
                     new Change(f, Operation._INCRE,5), 
                     new Change(j, Operation._INCRE,4), 
                     new Change(l, Operation._INCRE,5) ) ;
                   
                  Procesos P130 =      new Par(  new Change(a, Operation._DECRE,5),
                     new Change(f, Operation._INCRE,4), 
                     new Change(j, Operation._INCRE,10), 
                     new Change(k, Operation._INCRE,10) ) ;
                   
                  Procesos P131 =      new Par(  new Change(a, Operation._DECRE,6),
                     new Change(f, Operation._INCRE,3), 
                     new Change(j, Operation._INCRE,10), 
                     new Change(m, Operation._INCRE,10) ) ;
            ...
            Procesos P132 =      new Par(new Tell(new XeqC(a,220)),new Tell(new XeqC(b,220)),new Tell(new XeqC(c,220)),new Tell(new XeqC(d,220)),
                ...
                Procesos reaction = new Bang(  new Choice(   new AskChoice(new And(Ar.expre(  new XgteqC(h,7), 
                 ...
                 new AskChoice(new And(Ar.expre(  new XgteqC(h,2), 
                   new XgteqC(k,6)) ) ,P100)   , 
                 new AskChoice(new And(Ar.expre(  new XgteqC(a,8), 
                   new XgteqC(g,7), 
                   new XgteqC(h,1)) ) ,P101)   , 
                 new AskChoice(new And(Ar.expre(  new XgteqC(a,2), 
                   new XgteqC(g,2), 
                   new XgteqC(j,1)) ) ,P102)   , 
                 new AskChoice(new And(Ar.expre(  new XgteqC(a,4), 
                   new XgteqC(g,2), 
                   new XgteqC(j,1)) ) ,P103)   , 
                 new AskChoice(  new XgteqC(a,4),P104)   , 
                 new AskChoice(  new XgteqC(a,6),P105)   , 
                 new AskChoice(  new XgteqC(a,1),P106)   , 
                 new AskChoice(new And(Ar.expre(  new XgteqC(i,4), 
                   new XgteqC(m,8)) ) ,P107)   , 
                 new AskChoice(new And(Ar.expre(  new XgteqC(a,5), 
                   new XgteqC(h,7), 
                   new XgteqC(i,6)) ) ,P108)   , 
                 new AskChoice(new And(Ar.expre(  new XgteqC(a,3), 
                   new XgteqC(h,5), 
                   new XgteqC(i,8)) ) ,P109)   , 
                 new AskChoice(  new XgteqC(a,4),P110)   , 
                 new AskChoice(new And(Ar.expre(  new XgteqC(a,2), 
                   new XgteqC(h,5), 
                   new XgteqC(j,4)) ) ,P111)   , 
                 new AskChoice(new And(Ar.expre(  new XgteqC(a,5), 
                 ...
                 new AskChoice(new And(Ar.expre(  new XgteqC(j,5), 
                   new XgteqC(l,3)) ) ,P113)   , 
                 new AskChoice(new And(Ar.expre(  new XgteqC(h,6), 
                   new XgteqC(l,8)) ) ,P114)   , 
                 new AskChoice(new And(Ar.expre(  new XgteqC(h,3), 
                   new XgteqC(m,8)) ) ,P115)   , 
                 new AskChoice(new And(Ar.expre(  new XgteqC(a,7), 
                   new XgteqC(e,4), 
                   new XgteqC(h,1)) ) ,P116)   , 
                 new AskChoice(  new XgteqC(a,4),P117)   , 
                 new AskChoice(  new XgteqC(a,1),P118)   , 
                 new AskChoice(new And(Ar.expre(  new XgteqC(a,8), 
                   new XgteqC(e,2), 
                   new XgteqC(j,5)) ) ,P119)   , 
                 new AskChoice(new And(Ar.expre(  new XgteqC(i,6), 
                 ...
                 new AskChoice(new And(Ar.expre(  new XgteqC(a,8), 
                   new XgteqC(e,1), 
                   new XgteqC(i,3)) ) ,P121)   , 
                 new AskChoice(  new XgteqC(a,8),P122)   , 
                 new AskChoice(new And(Ar.expre(  new XgteqC(i,5), 
                   new XgteqC(m,6)) ) ,P123)   , 
                 new AskChoice(new And(Ar.expre(  new XgteqC(a,5), 
                   new XgteqC(f,7), 
                 ...
                 new AskChoice(new And(Ar.expre(  new XgteqC(a,2), 
                   new XgteqC(f,3), 
                   new XgteqC(h,1)) ) ,P126)   , 
                 new AskChoice(new And(Ar.expre(  new XgteqC(h,1), 
                   new XgteqC(l,2)) ) ,P127)   , 
                 new AskChoice(new And(Ar.expre(  new XgteqC(h,2), 
                   new XgteqC(k,7)) ) ,P128)   , 
                 new AskChoice(  new XgteqC(a,3),P129)   , 
                 new AskChoice(  new XgteqC(a,5),P130)   , 
                 new AskChoice(  new XgteqC(a,6),P131))    );
            ...
            Procesos P133 = new Par(P132,reaction);
              ...
              Ambient.getAmbient().readerVarsXml("GenReactV4.xml");

              // time unit of execution
              jntccGenReactV4.setTimeUnit(100);
              //Planner run
              jntccGenReactV4.run();
        }
    }